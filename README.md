...
![htmlscreenshots](./Screenshots/screenshot1.png)
![css/screenshots](./Screenshots/screenshot2.png)
...
I learned how to properly apply flexbox properties.
...
ChatGpt - I prompted it to first can the contents of my folder, by doing so making it familiarize with the folder contents. 
        ...
        - It then gave me a showed me a set of codes that wouldn't have achieved the desire standards in style-guide.md
        - I then decided to research extensively on flexbox css using mdn.
